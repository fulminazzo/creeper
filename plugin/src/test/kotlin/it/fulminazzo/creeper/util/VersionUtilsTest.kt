...
class VersionUtilsTest {
    ...
    private companion object {
        ...
        fun provideTestVersions(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of("1.8-SNAPSHOT", "8"),
            Arguments.of("1.8.9", "8"),
            // 1.9
            Arguments.of("1.9", "8"),
            Arguments.of("1.9.1", "8"),
            Arguments.of("1.9-SNAPSHOT", "8"),
            Arguments.of("1.9.4", "8"),
            // 1.10
            Arguments.of("1.10", "8"),
            Arguments.of("1.10.1", "8"),
            Arguments.of("1.10-SNAPSHOT", "8"),
            Arguments.of("1.10.2", "8"),
            // 1.11
            Arguments.of("1.11", "8"),
            Arguments.of("1.11.1", "8"),
            Arguments.of("1.11-SNAPSHOT", "8"),
            Arguments.of("1.11.2", "8"),
            // 1.12
            Arguments.of("1.12", "8"),
